<p align="center">
  <img src="./avatar.png" alt="BA KeySmith Avatar" width="140">
</p>

<h1 align="center">BA KeySmith</h1>

<p align="center">
  <strong>BA KeySmith</strong>（简称 <strong>BAKS</strong>） 是用于蔚蓝档案（Blue Archive）PC 端的键位映射与自定义宏的 Windows 工具。
  <br>
  将用户实际按下的键转换为游戏内按键输入，例如 <code>q -&gt; 1</code>；也可以把键盘或鼠标按键绑定为宏触发键，执行连点、等待、循环、组合键、鼠标拖拽等操作。
</p>

# 注意：此项目功能边界已确认，正在进行重构
重构版的重构的重构正在重构中...
...
<img width="962" height="712" alt="屏幕截图 2026-05-19 034558" src="https://github.com/user-attachments/assets/c4eaa154-5d9f-4b69-a412-f2ec206bd5d2" />
...
`v0.1.0`升级至`v0.2.0`的用户首次执行新版程序时程序将自动转移同目录的配置文件至用户数据目录：
